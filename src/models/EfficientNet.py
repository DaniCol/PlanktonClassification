...
class MBConvBlock(nn.Module):  # pylint: disable=too-many-instance-attributes
    ...
    def __init__(self, block_args, global_params, image_size=None):
        ...
        if self._block_args.expand_ratio != 1:
            ...
            # <-- this wouldn't modify image_size
...
class EfficientNet(nn.Module):  # pylint: disable=too-many-instance-attributes
    """EfficientNet model.
    ...
    def from_name(cls, model_name, in_channels=3, **override_params):
        ...
        model._change_in_channels(in_channels)  # pylint: disable=protected-access
        return model
